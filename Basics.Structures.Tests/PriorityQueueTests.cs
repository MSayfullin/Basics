...
namespace Basics.Structures.Tests
{
    ...
    {
        [TestMethod]
        public void PriorityQueue_SingleEnqueueDequeueTest()
        {
            string test = "test";
        ...
        [TestMethod]
        public void PriorityQueue_MultipleEnqueueDequeueTest()
        {
        ...
        public void PriorityQueue_GetMaxFromEmptyQueueTest()
        {
            var queue = new MaxPriorityQueue<string>();
            var max = queue.Max;
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void PriorityQueue_DequeueMaxFromEmptyQueueTest()
        {
            var queue = new MaxPriorityQueue<string>();
            queue.DequeueMax();
        }
        ...
        [TestMethod]
        public void PriorityQueue_Empty_EnumeratorTest()
        {
            var queue = new MaxPriorityQueue<string>();
        ...
        [TestMethod]
        public void PriorityQueue_Full_EnumeratorTest()
        {
